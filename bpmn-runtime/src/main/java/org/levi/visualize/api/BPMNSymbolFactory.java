...
public class BPMNSymbolFactory {
    ...
    public void endEvent(String name, String id) {
        ...
        gv.addln(id + " [shape=circle,fixedsize=true,width=.5, style=\"setlinewidth(3)\", height=.5, label = \"" + name + "\"];");
    }
    ...
    public void normalTask(String name, String id) {
        gv.addln(id + " [shape=box,style=rounded,fontsize=9,fixedsize=true,width=2, height=.9,label = \"" + name + "\"];");
    }
