 ...
 *
 * </dl>
 * @version v0.3a, 2011/02/04 (February) -- Support for multiple file types by Keheliya ;-) 
...
//   private static String DOT = "c:/Program Files/Graphviz2.26.3/bin/dot.exe";	// Windows
    ...
    * @param type Type of the output image to be produced. eg: dot,fig,pdf,ps,svg,png
