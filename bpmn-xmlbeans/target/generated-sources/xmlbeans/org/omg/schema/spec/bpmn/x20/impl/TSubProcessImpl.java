 ...
 */
public class TSubProcessImpl extends org.omg.schema.spec.bpmn.x20.impl.TActivityImpl implements org.omg.schema.spec.bpmn.x20.TSubProcess
{
    ...
    private static final javax.xml.namespace.QName TRIGGEREDBYEVENT$4 = 
    ...
    public boolean getTriggeredByEvent()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(TRIGGEREDBYEVENT$4);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(TRIGGEREDBYEVENT$4);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetTriggeredByEvent()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(TRIGGEREDBYEVENT$4);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(TRIGGEREDBYEVENT$4);
            }
            return target;
        }
    }
    ...
    public boolean isSetTriggeredByEvent()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(TRIGGEREDBYEVENT$4) != null;
        }
    }
    ...
    public void setTriggeredByEvent(boolean triggeredByEvent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(TRIGGEREDBYEVENT$4);
            }
    ...
    public void xsetTriggeredByEvent(org.apache.xmlbeans.XmlBoolean triggeredByEvent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(TRIGGEREDBYEVENT$4);
            }
    ...
    public void unsetTriggeredByEvent()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(TRIGGEREDBYEVENT$4);
        }
    }
}
