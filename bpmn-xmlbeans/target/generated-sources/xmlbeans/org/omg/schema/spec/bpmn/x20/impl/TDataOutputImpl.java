 ...
 */
public class TDataOutputImpl extends org.omg.schema.spec.bpmn.x20.impl.TBaseElementImpl implements org.omg.schema.spec.bpmn.x20.TDataOutput
{
    private static final long serialVersionUID = 1L;
    
    public TDataOutputImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ISCOLLECTION$6 = 
    ...
    public boolean getIsCollection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ISCOLLECTION$6);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(ISCOLLECTION$6);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetIsCollection()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(ISCOLLECTION$6);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(ISCOLLECTION$6);
            }
            return target;
        }
    }
    ...
    public boolean isSetIsCollection()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(ISCOLLECTION$6) != null;
        }
    }
    ...
    public void setIsCollection(boolean isCollection)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ISCOLLECTION$6);
            }
    ...
    public void xsetIsCollection(org.apache.xmlbeans.XmlBoolean isCollection)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(ISCOLLECTION$6);
            }
    ...
    public void unsetIsCollection()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(ISCOLLECTION$6);
        }
    }
}
