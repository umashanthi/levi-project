    ...
    <div class="header">
        <div class="header_resize">
          ...
          <input name="editbox_search" class="editbox_search" id="editbox_search" maxlength="80" value="Search our ste:"
            ...
            <div class="menu_nav">
                <ul>
                    <li><a href="/troubleticket/tasks?assigned=true"><span>My Issues</span></a></li>
                    <li class="active"><a href="/troubleticket/tasks?assigned=false"><span>Unassigned Issues</span></a></li>
                    <li><a href="openissues.html"><span>Open Issues</span></a></li>
                    <li><a href="closedissues.html"><span>Closed Issues</span></a></li>
                    <li><a href="newissue.html"><span>Create New Issue</span></a></li>
                </ul>
            </div>
            <div class="clr"></div>
            <div class="clr"></div>
