...
<head>
    <title>Processed Loan Applications</title>
...
<div class="main">
        ...
        <div class="header_resize">
            ...
            <div class="menu_nav">
                <ul>
                    ...
                    <li class="active"><a href="listProcesses?type=completed"><span>Completed Applications</span></a></li>
                    <%} %>
    ...
    <div class="content">
        <div class="content_resize">
            <div class="mainbar">
                <div class="article">
                    <h2><span>Completed Applications</span></h2>
                    ...
                    <%} else {%>
                    <ul class="sb_menu">
                        <li><strong>No completed loan applications available</strong></li>
                    </ul>
                    <% }%>
                </div>
            </div>
